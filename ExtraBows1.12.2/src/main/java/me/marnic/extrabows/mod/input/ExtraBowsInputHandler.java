package me.marnic.extrabows.mod.input;

import me.marnic.extrabows.mod.main.ExtraBows;
import me.marnic.extrabows.mod.main.Identification;
import me.marnic.extrabows.mod.packet.ExtraBowsPacketHandler;
import me.marnic.extrabows.mod.packet.PacketOpenUpgradeGUI;
...
public class ExtraBowsInputHandler {
    ...
    private static KeyBinding OPEN_UPGRADE_INV;
