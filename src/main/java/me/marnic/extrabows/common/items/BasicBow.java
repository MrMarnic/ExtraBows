        ...
        if (entityLiving instanceof PlayerEntity) {
            ...
            if (!arrowStack.isEmpty() || flag) {
                ...
                if ((double) f >= 0.1D) {
                    ...
                    worldIn.playSound(null, entityplayer.posX, entityplayer.posY, entityplayer.posZ, SoundEvents.ENTITY_ARROW_SHOOT, SoundCategory.PLAYERS, 1.0F, 1.0F / (RandomUtil.RANDOM.nextFloat() * 0.4F + 1.2F) + f * 0.5F);
