...
public class ExtraBowsObjects {
    ...
    public static void init() {
        ...
        BRIDGE_BLOCK_TYPE = Registry.register(Registry.BLOCK_ENTITY, IdentificationUtil.fromString("bridge_block_entity"),BlockEntityType.Builder.create(BlockEntityBridgeBlock::new,BRIDGE_BLOCK).build(null));
